...
_ALIASES = {
    ...
    # Legacy defensive-mode values are folded into the remaining conservative mode.
    "主动避险": TRADE_MODE_CASH_RECOVERY,
    "risk_off": TRADE_MODE_CASH_RECOVERY,
    "bear": TRADE_MODE_CASH_RECOVERY,
    "defensive": TRADE_MODE_CASH_RECOVERY,
}
